...
class NewRoomReservation extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'occupancy' => ['required', 'strong', 'in:TRAINEE,NON-PAYING GUEST/VISITOR,NMP PERSONNEL (REGULAR/JOW),PAYING GUEST/VISITOR'],
            ...
            'remarks' => ['required_if:status,REJECTED', 'string'],
